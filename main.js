...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/isToday/index.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/isSameWeek/index.js");
/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ "./src/style.css");
/* harmony import */ var _icons_inbox_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./icons/inbox.svg */ "./src/icons/inbox.svg");
/* harmony import */ var _icons_today_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./icons/today.svg */ "./src/icons/today.svg");
/* harmony import */ var _icons_week_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./icons/week.svg */ "./src/icons/week.svg");
/* harmony import */ var _icons_important_svg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./icons/important.svg */ "./src/icons/important.svg");
/* harmony import */ var _icons_folder_svg__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./icons/folder.svg */ "./src/icons/folder.svg");
/* harmony import */ var _icons_project_svg__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./icons/project.svg */ "./src/icons/project.svg");
/* harmony import */ var _icons_remove_svg__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./icons/remove.svg */ "./src/icons/remove.svg");
...
/* harmony import */ var _icons_exp_more_svg__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./icons/exp more.svg */ "./src/icons/exp more.svg");
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./index.js */ "./src/index.js");
...
const todayDate = addElement(
  "div",
  "today-date",
  `${(0,date_fns__WEBPACK_IMPORTED_MODULE_11__["default"])(new Date(), "eeee dd/MMM/yyyy")}`
);
...
const bInbox = addElement("div", "inbox", `<img src=${_icons_inbox_svg__WEBPACK_IMPORTED_MODULE_1__}></img> Inbox`);
const bToday = addElement("div", "today", `<img src=${_icons_today_svg__WEBPACK_IMPORTED_MODULE_2__}></img> Today`);
const bThisweek = addElement(
  "div",
  "this-week",
  `<img src=${_icons_week_svg__WEBPACK_IMPORTED_MODULE_3__}></img> This week`
);
const bImportant = addElement(
  "div",
  "important",
  `<img src=${_icons_important_svg__WEBPACK_IMPORTED_MODULE_4__}></img> Important`
);
boxes.append(bInbox, bToday, bThisweek, bImportant);
const projectBoxTitle = addElement(
  "div",
  "project-box-title",
  `<img src=${_icons_folder_svg__WEBPACK_IMPORTED_MODULE_5__}></img>Projects`
);
...
function displayTodoBox(todo) {
  ...
  const deleteTodo = addElement(
    "div",
    "delete-todo",
    `<img src=${_icons_remove_svg__WEBPACK_IMPORTED_MODULE_7__}></img>`
  );
  ...
  date.innerHTML = `${(0,date_fns__WEBPACK_IMPORTED_MODULE_11__["default"])(todo.dueDate, "eee dd,MMM")}`;
  const detail = addElement(
    "div",
    "todo-details",
    `<img src=${_icons_exp_more_svg__WEBPACK_IMPORTED_MODULE_9__}></img>`
  );
...
function displayProjectName(p) {
  ...
  const projectNameElement = addElement(
    ...
    `<img src=${_icons_project_svg__WEBPACK_IMPORTED_MODULE_6__}></img> ${p.name}`
  );
  const deleteProjectElement = addElement(
    "div",
    "delete-project",
    `<div class'delete-project'><img src=${_icons_delete_svg__WEBPACK_IMPORTED_MODULE_8__}></img></div> `
  );
  ...
  deleteProjectElement.addEventListener("click", () => {
    ...
    _index_js__WEBPACK_IMPORTED_MODULE_10__.listOfProjects.splice(_index_js__WEBPACK_IMPORTED_MODULE_10__.listOfProjects.indexOf(p), 1);
    displayProject(_index_js__WEBPACK_IMPORTED_MODULE_10__.listOfProjects[0]);
  });
}
...
projectFormButtons.addEventListener("click", () => {
  if (newProjectTitle.value !== "") {
    ...
    const p = new _index_js__WEBPACK_IMPORTED_MODULE_10__.Project(newProjectTitle.value);
    _index_js__WEBPACK_IMPORTED_MODULE_10__.listOfProjects.push(p);
...
function createTodoForm() {
  ...
  _index_js__WEBPACK_IMPORTED_MODULE_10__.listOfProjects.forEach((pro, i) => {
  ...
  confirmBtn.addEventListener("click", () => {
    if (dateInput.value !== "") {
      ...
      const newTodo = new _index_js__WEBPACK_IMPORTED_MODULE_10__.ToDo(
        nameInput.value,
        descText.value,
      ...
      newTodo.project = _index_js__WEBPACK_IMPORTED_MODULE_10__.listOfProjects[projectSelect.value];
      _index_js__WEBPACK_IMPORTED_MODULE_10__.listOfProjects[projectSelect.value].addToDoToList(newTodo);
      displayProject(_index_js__WEBPACK_IMPORTED_MODULE_10__.listOfProjects[projectSelect.value]);
      nameInput.value = "";
      descText.value = "";
      pop.style.display = "none";
      todoForm.style.display = "none";
...
const today = new _index_js__WEBPACK_IMPORTED_MODULE_10__.Project("Today");

const week = new _index_js__WEBPACK_IMPORTED_MODULE_10__.Project("This week");

const importantProjects = new _index_js__WEBPACK_IMPORTED_MODULE_10__.Project("Important");
...
bToday.addEventListener("click", () => {
  today.listOfToDos = [];
  _index_js__WEBPACK_IMPORTED_MODULE_10__.listOfProjects.forEach((prj) => {
    prj.listOfToDos.forEach((t) => {
      if ((0,date_fns__WEBPACK_IMPORTED_MODULE_12__["default"])(t.dueDate)) {
...
bThisweek.addEventListener("click", () => {
  ...
  _index_js__WEBPACK_IMPORTED_MODULE_10__.listOfProjects.forEach((prj) => {
    prj.listOfToDos.forEach((t) => {
      if ((0,date_fns__WEBPACK_IMPORTED_MODULE_13__["default"])(t.dueDate, new Date(), { weekStartsOn: 6 })) {
...
(0,_dom__WEBPACK_IMPORTED_MODULE_0__.displayProject)(listOfProjects[0]);
listOfProjects.forEach((p, i) => {
  if (i > 0) (0,_dom__WEBPACK_IMPORTED_MODULE_0__.displayProjectName)(p);
});
  ...
  listOfProjects.forEach((project) => {
    ...
    project.listOfToDos.forEach((todo) => {
      todos = `${todos.slice(0, -1)}, [${todo.title}, ${todo.description}, ${
        todo.priority
      }, ${(0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__["default"])(todo.dueDate, "yyyy/MM/dd")}, ${todo.completed}, ${
        todo.important
      }]]`;
    });
...
module.exports = __webpack_require__.p + "dcae19c272140b30fcf0.svg";
...
module.exports = __webpack_require__.p + "bf1f240722863499a4d3.svg";
...
module.exports = __webpack_require__.p + "f28c3bd79730c23529eb.svg";
...
module.exports = __webpack_require__.p + "68666895858479f499f5.svg";
