...
const todayDate = addElement(
  "div",
  "today-date",
  `${(0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(new Date(), "eeee dd/MMM/yyyy")}`
);
...
const defaultProject = addElement(
  "div",
  "project",
  `<img src=${_icons_project_svg__WEBPACK_IMPORTED_MODULE_6__}></img> default project`
);
...
function displayTodoBox(todo) {
  ...
  date.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(todo.date, "eee dd,MMM");
