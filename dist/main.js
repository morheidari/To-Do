...
const todayDate = addElement(
  "div",
  "today-date",
  `${(0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), "eeee dd/MMM/yyyy")}`
);
...
boxes.append(bInbox, bToday, bThisweek);
...
function displayTodoBox(todo) {
  ...
  date.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(todo.date, "eee dd,MMM");
